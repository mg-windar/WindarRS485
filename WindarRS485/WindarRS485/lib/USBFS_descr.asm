...
;----------------------------------------------------------------------
  ...
  DB    0                                        ; bInterval
;----------------------------------------------------------------------
; Endpoint Descriptor (USBFS_D0_C1_I0_E1)
;----------------------------------------------------------------------
  DB    7                                        ; Endpoint Descriptor Length (7)
  DB    5                                        ; bDescriptorType: ENDPOINT
...
;----------------------------------------------------------------------
USBFS_HID_RPT_1_OUT_RPT_SIZE:  EQU    8          ; TODO: Optimize report size
;----------------------------------------------------------------------
USBFS_HID_RPT_1_FEATURE_RPT_SIZE:  EQU    0      ; No FEATURE Reports are defined.  Size set to 0.
;----------------------------------------------------------------------
; HID Report Sizes (HID_RPT_2}
;----------------------------------------------------------------------
USBFS_HID_RPT_2_IN_RPT_SIZE:  EQU    8           ; TODO: Optimize report size
;----------------------------------------------------------------------
USBFS_HID_RPT_2_OUT_RPT_SIZE:  EQU    8          ; TODO: Optimize report size
;----------------------------------------------------------------------
USBFS_HID_RPT_2_FEATURE_RPT_SIZE:  EQU    0      ; No FEATURE Reports are defined.  Size set to 0.
;----------------------------------------------------------------------
; HID Report Sizes (HID_RPT_3}
;----------------------------------------------------------------------
USBFS_HID_RPT_3_IN_RPT_SIZE:  EQU    8           ; TODO: Optimize report size
;----------------------------------------------------------------------
USBFS_HID_RPT_3_OUT_RPT_SIZE:  EQU    8          ; TODO: Optimize report size
;----------------------------------------------------------------------
USBFS_HID_RPT_3_FEATURE_RPT_SIZE:  EQU    0      ; No FEATURE Reports are defined.  Size set to 0.
;----------------------------------------------------------------------
;----------------------------------------------------------------------

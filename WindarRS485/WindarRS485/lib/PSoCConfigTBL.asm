...
export LoadConfigTBL_usb_test_Bank1
export LoadConfigTBL_usb_test_Bank0
export LoadConfigTBL_usb_test_Ordered
AREA lit(rom, rel)
LoadConfigTBL_usb_test_Bank0:
...
;       Instance name Timer8_1, Block Name TIMER8(DBB00)
	...
	db		21h, 00h		;Timer8_1_PERIOD_REG(DBB00DR1)
...
;  Global Register values Bank 0
	...
	db		b0h, 88h		; Row_0_InputMux register (RDI0RI)
	db		b1h, 09h		; Row_0_InputSync register (RDI0SYN)
	...
	db		b5h, 80h		; Row_0_OutputDrive_0 register (RDI0SRO0)
...
;  Global Register values Bank 1
	...
	db		64h, 00h		; ComparatorGlobalOutEn1 register (CMP_GO_EN1)
	...
	db		d1h, 01h		; GlobalDigitalInterconnect_Drive_Even_Input register (GDI_E_IN)
...
LoadConfigTBL_usb_test_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[03h], ddh		; Port_0_DriveMode_2 register (PRT0DM2)
	...
	mov	reg[06h], a8h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
	...
	M8C_SetBank1
	mov	reg[08h], 30h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], cfh		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], cfh		; Port_2_DriveMode_2 register (PRT2DM2)
	...
	mov	reg[0ch], 28h		; Port_3_Data register (PRT3DR)
	M8C_SetBank1
	mov	reg[0ch], 08h		; Port_3_DriveMode_0 register (PRT3DM0)
	mov	reg[0dh], 9fh		; Port_3_DriveMode_1 register (PRT3DM1)
	M8C_SetBank0
	mov	reg[0fh], bdh		; Port_3_DriveMode_2 register (PRT3DM2)

...
export LoadConfig_usb_test
export _LoadConfig_usb_test
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_3_Data_SHADE], 28h

	lcall	LoadConfig_usb_test
	lcall	LoadConfigTBL_usb_test_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration usb_test
;
;    Load configuration registers for usb_test.
...
_LoadConfig_usb_test:
 LoadConfig_usb_test:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_usb_test_Bank0
    mov     X, <LoadConfigTBL_usb_test_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_usb_test_Bank1
    mov     X, <LoadConfigTBL_usb_test_Bank1
